...
def display_game_status(letters_alphabet, guessed_letters, hidden_word, attempts_remain):
    print("Word: " + game_logic.get_hidden_word_with_visible_guessed_letters(hidden_word,guessed_letters))
    print("Letters: " +game_logic.alphabet_display_with_guessed_letters_marked(letters_alphabet,guessed_letters))
    print("Attempts remaining: " + str(attempts_remain))
    ...
